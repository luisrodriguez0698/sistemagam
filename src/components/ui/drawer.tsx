...
// Componente base generado en el estilo shadcn/ui, envolviendo `vaul`.
// A partir de aquí NUNCA se debe usar `Dialog` para formularios: todo el
// sistema construye sus paneles sobre este primitivo (ver AppDrawer).
